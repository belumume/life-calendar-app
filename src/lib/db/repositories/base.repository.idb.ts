...
export abstract class BaseRepositoryIDB<T extends { id: string }> implements Repository<T> {
  protected db: IndexedDatabase;
  protected storeName: string;

  constructor(db: IndexedDatabase, storeName: string) {
    this.db = db;
